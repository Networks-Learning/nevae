...
#fname = '../../data/ZINC.smi'
#fname = '../../../data/drug_like/lowPH/training/smiles_30/smiles.txt'
#fname = '../../../data/drug_like/lowPH/figure_30/smiles.txt'
fname = '../../../data/drug_like/lowPH/training/BO_45/smiles.txt'
