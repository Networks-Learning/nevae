...
def add_arguments(parser):
    ...
    parser.add_argument("--sample_edge", type=int, default=5, help="Edge to sample")
    parser.add_argument("--sample_node", type=int, default=5, help="Node to sample")
...
if __name__ == '__main__':
    ...
    #Test code
    #'''
    model2 = VAEG(hparams, placeholders, hparams.sample_node, 1, [])
